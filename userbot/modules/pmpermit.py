...
# ========================= CONSTANTS ============================
UNAPPROVED_MSG = ( "` Hei! Maaf, aku belum menyetujui kamu untuk PM.` \ n " "` Tolong tunggu saya untuk melihat`` n " "` Sampai saat itu, tolong jangan spam PM saya..` \ n " "` Terima kasih telah bersabar. ` \ N \ n " "` * Ini adalah pesan otomatis` " )
# =================================================================
